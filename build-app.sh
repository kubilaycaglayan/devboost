...
chmod 755 "$STAGE_APP/Contents/Resources/devboost.py" "$STAGE_APP/Contents/Resources/bin/DevBoost-dashboard" "$STAGE_APP/Contents/Resources/bin/DevBoost-tunnel"
